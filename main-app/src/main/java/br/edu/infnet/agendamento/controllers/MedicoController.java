...
public class MedicoController {
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<Medico> obterPorId(@PathVariable("id") Integer id) {
    ...
    public ResponseEntity<Optional<List<Agendamento>>> obterAgendamentos(@PathVariable("id") Integer id) {
